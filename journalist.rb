...
#exercice 1
journalist_number = my_array.length
puts "Le nombre de journalistes est #{journalist_number}"


#exercice 2
number_journalist = my_array.grep(/[1-9]/).count 
puts "Le nombre de journalistes contenant un chiffre dans son nom est #{number_journalist}"

#exercice 3
maj_journalist = my_array.grep(/aude/i).count 
puts "Le nombre de journalistes contenant un chiffre dans son nom est #{maj_journalist}"

#exercice 4
maj_journalist = my_array.grep(/@[A-Z]/).count 
puts "Le nombre de journalistes commencant par une majuscule  est #{maj_journalist}"
